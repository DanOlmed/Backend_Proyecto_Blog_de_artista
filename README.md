...
## 🏛️ 5. Decisiones de Arquitectura (ADR)

Para asegurar la claridad y trazabilidad de las decisiones de diseño del backend, se han documentado los siguientes Registros de Decisiones de Arquitectura (ADR).
